 ...
 * @author Hugo
 */
public class RemocaoFuncionarioAtracao extends javax.swing.JFrame {
    private BDController bDController;

    /**
     * Creates new form RemocaoFuncionarioAtracao
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().trim() != "" && jTextField2.getText().trim() != "") {
            ...
            try {
                bDController.removeFuncionarioAtracao(Integer.valueOf(jTextField1.getText().toString()),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemocaoFuncionarioAtracao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemocaoFuncionarioAtracao().setVisible(true);
            }
        });
    }
