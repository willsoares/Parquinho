 ...
 * @author wills
 */
public class RemoveEstoque extends javax.swing.JFrame {

    private BDController bDController;

    /**
     * Creates new form RemoveEstoque
     */
    public RemoveEstoque() {
        ...
        setTitle("Remover produto do Estoque");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (jTextField1.getText().trim() != "" && jTextField2.getText().trim() != "") {
            ...
            try {
                bDController.removeEstoque(Integer.valueOf(jTextField2.getText().toString()),
