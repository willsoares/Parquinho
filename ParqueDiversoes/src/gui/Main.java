...
import gui.functions.AtualizaEstoque;
import gui.functions.SolicitaFucnionario;
...
import gui.remocao.RemoveEstoque;
...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton23.setText("Estoque da Loja");
        ...
        jButton24.setText("Atrações Ativas");
        ...
        jButton25.setText("Solicitar Funcionário");
        ...
        jButton28.setText("Remove Produto do Estoque");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(33, 33, 33)
                                        .addComponent(jButton23, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton25ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton25ActionPerformed
        ...
        //If a string was returned, say so.
        if ((s != null) && (s.length() > 0)) {
            SolicitaFucnionario solicitaFuncionario;
            try {
                solicitaFuncionario = new SolicitaFucnionario(s);
                solicitaFuncionario.setVisible(rootPaneCheckingEnabled);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
            } catch (SQLException ex) {
                Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
