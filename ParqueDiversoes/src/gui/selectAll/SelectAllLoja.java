 ...
 * @author Hugo
 */
public class SelectAllLoja extends javax.swing.JFrame {

    private BDController bDController;

    /**
     * Creates new form SelectAllLoja
     */
    public SelectAllLoja() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    private void preencheCampo() throws ClassNotFoundException, SQLException {
        ...
        ArrayList<Loja> lojas = bDController.selectAllLoja();
